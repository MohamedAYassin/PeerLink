  ...
  return (
      <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-300">
              If you have any questions about this site, please contact me at&nbsp;
              <a href="mailto:webmaster@peerlink.live" className="text-blue-500 underline">webmaster@peerlink.live</a>.
          </p>
